...
CREATE TABLE `pizza_sabor` (
  ...
  CONSTRAINT `pizza_sabor_ibfk_1` FOREIGN KEY (`pizza_id`) REFERENCES `pizza_tb` (`pizza_id`),
  CONSTRAINT `pizza_sabor_ibfk_2` FOREIGN KEY (`sabor_id`) REFERENCES `sabor_tb` (`sabor_id`)
